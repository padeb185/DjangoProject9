...
SECRET_KEY = 'django-insecure-yhwy=ug1wg)@vbpk$rd#n@5fi^5gw@_-opzet^3t7fzh&cj-_('
...
# Ajoute cette ligne pour définir le dossier où collecter les fichiers statiques
